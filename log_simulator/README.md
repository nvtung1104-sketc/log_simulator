...
If needed, I can:
- Add screenshots/screencasts and a complete "Run" badge (with OWNER/REPO).
- Create LICENSE, .gitignore, or sample CI workflow files and commit directly to the workspace.
